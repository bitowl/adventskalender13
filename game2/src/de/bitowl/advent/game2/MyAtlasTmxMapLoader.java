 ...
 * @author Manuel Bua */
public class MyAtlasTmxMapLoader extends AsynchronousAssetLoader<TiledMap, MyAtlasTmxMapLoader.AtlasTiledMapLoaderParameters> {
	...
	public MyAtlasTmxMapLoader () {
		super(new InternalFileHandleResolver());
	}

	public MyAtlasTmxMapLoader (FileHandleResolver resolver) {
		super(resolver);
	}
